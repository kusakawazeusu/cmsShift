            ...
            <div class="row row-offcanvas row-offcanvas-left">
                <div class="col-xs-2 col-sm-2 sidebar-offcanvas" id="sidebar">
                    <div class="list-group">
                        ...
                        <a href="#" onclick="document.getElementById('page').src='Search'" class="list-group-item">查詢功能</a>
                ...
                <div class="iframe-rwd">
                    <iframe id="page" src="" height="100%" width="80%" scrolling="no" frameborder="0" style="border:0" onload="ResetWindowSize()"></iframe>
                </div>                 
                <!--/.col-xs-12.col-sm-9-->
                <!--/.sidebar-offcanvas-->
            </div>
