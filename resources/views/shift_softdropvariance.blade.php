...
<h4 class="text-center"><a href="/shift/dw" class="btn btn-sm btn-success">上一個項目</a> 帳務日期：{{ $Drop }} <a href="/shift/metervariance/{{ $Drop }}" class="btn btn-sm btn-danger">完成「入抄變動」</a></h4>
