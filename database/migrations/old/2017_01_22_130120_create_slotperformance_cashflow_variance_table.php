...
class CreateSlotperformanceCashflowVarianceTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        //
        Schema::create('slotperformancecashflowvariance', function (Blueprint $table) {
            //
            $table->increments('id');
    ...
    {
        //
        Schema::drop('slotperformancecashflowvariance');
    }
}
