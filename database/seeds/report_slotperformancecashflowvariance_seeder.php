...
class report_slotperformancecashflowvariance_seeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        report_slotperformancecashflowvariance::truncate();
        foreach(range (1,150) as $number)
        {
            report_slotperformancecashflowvariance::insert ([
            	'Mnum' =>990000+$number,
